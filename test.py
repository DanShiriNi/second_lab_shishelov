...
def test_update_user_details():
    ...
    update_data = {"username": "Updated_username", "email": "updated_email@example.com", "full_name": "Updated Full Name", "password": "updated_password_123"}
    valid_token_headers = {"Authorization": access_token}
